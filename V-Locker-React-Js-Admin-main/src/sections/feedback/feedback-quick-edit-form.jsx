...
export const FeedbackQuickEditSchema = zod.object({
...
export function FeedbackQuickEditForm({ currentUser, open, onClose, update }) {
  ...
  const methods = useForm({
    mode: 'all',
    resolver: zodResolver(FeedbackQuickEditSchema),
    defaultValues,
  });
