...
import { useGetAllStateQuery } from 'src/redux/rtk/api';
...
// ----------------------------------------------------------------------
import { StateQuickEditForm } from './state-quick-edit-form';
  ...
  return isLoading && !fetchedData ? (
    ...
    <>
      <DashboardContent>
        <CustomBreadcrumbs
          heading="State List"
          links={[{ name: 'Dashboard', href: paths.dashboard.root }, { name: 'State' }]}
          action={
            <Button
      ...
      />
      <StateQuickEditForm update={isUpdate} open={quickEdit.value} onClose={quickEdit.onFalse} />
    </>
  );
}
