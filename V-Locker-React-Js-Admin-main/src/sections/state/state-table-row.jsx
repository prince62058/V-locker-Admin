...
import { useDeleteStateMutation } from 'src/redux/rtk/api';
...
import { StateQuickEditForm } from './view/state-quick-edit-form';
// ----------------------------------------------------------------------
...
export function StateTableRow({
  ...
  const [deleteBrand] = useDeleteStateMutation();
      ...
      <TableRow hover selected={selected} aria-checked={selected} tabIndex={-1}>
        ...
        <TableCell>
          <Stack direction="row" alignItems="center">
            <Tooltip title="View Cities" placement="top" arrow>
              <IconButton
