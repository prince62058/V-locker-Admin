...
import { useGetAllCityQuery } from 'src/redux/rtk/api';
...
// ----------------------------------------------------------------------
import { CityQuickEditForm } from './city-quick-edit-form';
...
const TABLE_HEAD = [
  ...
  { id: 'name', label: 'State Name', width: 120 },
  { id: 'bname', label: 'City Name', width: 120 },
      ...
      <DashboardContent>
        <CustomBreadcrumbs
          ...
          links={[
            ...
            { name: 'State', href: paths.dashboard.state.list },
            { name: 'City' },
          ]}
          action={
            <Button
