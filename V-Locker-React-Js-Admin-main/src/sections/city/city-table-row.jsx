...
import { useDeleteCityMutation } from 'src/redux/rtk/api';
...
import { CityQuickEditForm } from './view/city-quick-edit-form';
// ----------------------------------------------------------------------

export function CityTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow, index,currentPage }) {
