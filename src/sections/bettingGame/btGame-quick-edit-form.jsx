...
export const BtGameQuickEditSchema = zod.object({
...
export function BtGameQuickEditForm({ currentUser, open, onClose, update }) {
  ...
  const methods = useForm({
    mode: 'all',
    resolver: zodResolver(BtGameQuickEditSchema),
    defaultValues,
  });
