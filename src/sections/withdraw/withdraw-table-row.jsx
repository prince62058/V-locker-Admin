...
import { useUpdateWithdrawStatusMutation } from 'src/redux/rtk/api';
...
export function WithdrawTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow, index }) {
