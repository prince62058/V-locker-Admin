...
import { useDeleteBrandMutation } from 'src/redux/rtk/api';
...
import { BrandQuickEditForm } from './view/brand-quick-edit-form';
// ----------------------------------------------------------------------

export function BrandTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow, index ,currentPage}) {
