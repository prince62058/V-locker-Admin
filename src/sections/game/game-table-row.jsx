...
import { GameQuickEditForm } from './view/game-quick-edit-form';
// ----------------------------------------------------------------------

export function GameTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow, index }) {
    ...
    <>
      <TableRow hover selected={selected} aria-checked={selected} tabIndex={-1}>
        ...
        <TableCell>
          <Stack spacing={2} direction="row" alignItems="center">
            <Stack sx={{ typography: 'body2', flex: '1 1 auto', alignItems: 'flex-start' }}>
              <Box component="span" sx={{ color: 'text.disabled' }} dangerouslySetInnerHTML={{ __html: row?.description ?? '-' }}>
                {/* {row?.description ?? '-'} */}
              </Box>
            </Stack>
          </Stack>
