...
import { useGetAllGamesQuery } from 'src/redux/rtk/api';
...
// ----------------------------------------------------------------------
import { GameQuickEditForm } from './game-quick-edit-form';
  ...
  return isLoading && !fetchedData ? (
    ...
    <>
      <DashboardContent>
        <CustomBreadcrumbs
          heading="Game List"
          links={[{ name: 'Dashboard', href: paths.dashboard.root }, { name: 'Game' }]}
          action={
            <Button
      ...
      />
      <GameQuickEditForm update={isUpdate} open={quickEdit.value} onClose={quickEdit.onFalse} />
    </>
  );
}
